...
#ifdef UNDEFINED // JET causes problems for VS 2003.
///////////////////////////////////////////////////////
//
// CJetEngine Class
//
...
BOOL CADODatabase::Open(LPCTSTR lpstrConnection, LPCTSTR lpstrUserID, LPCTSTR lpstrPassword, CString* errMsg /* = NULL*/)
{
	HRESULT hr = S_OK;
	...
	{
		dump_com_error(e, errMsg);
		return FALSE;
	}

}

void CADODatabase::dump_com_error(_com_error &e, CString* errMsg /* = NULL*/)
{
	CString ErrorStr;
  ...
  m_strLastError.Format( "%s", (LPCSTR)bstrDescription);
	...
	//cout << ErrorStr << endl;
	if( NULL != errMsg ) *errMsg = ErrorStr;
}
...
BOOL CADORecordset::Open(_ConnectionPtr mpdb, LPCTSTR lpstrExec, int nOption, CString* errMsg /* = NULL*/)
{
	Close();
...
BOOL CADORecordset::Open(LPCTSTR lpstrExec, int nOption, CString* errMsg /*= NULL*/)
{
	ASSERT(m_pConnection != NULL);
	ASSERT(m_pConnection->GetState() != adStateClosed);
	return Open(m_pConnection, lpstrExec, nOption, errMsg);
}

BOOL CADORecordset::OpenSchema(int nSchema, LPCTSTR SchemaID /*= _T("")*/, CString* errMsg /* = NULL*/)
{
	try
	{
...
BOOL CADORecordset::Requery(CString* errMsg /* = NULL*/)
{
	if(IsOpen())
	{
		try
...
BOOL CADORecordset::GetFieldValue(LPCTSTR lpFieldName, double& dbValue, CString* errMsg /* = NULL*/)
{
...
BOOL CADORecordset::GetFieldValue(int nIndex, double& dbValue, CString* errMsg /* = NULL*/)
{
	double val = (double)NULL;
	_variant_t vtFld;
	_variant_t vtIndex;
...
BOOL CADORecordset::GetFieldValue(LPCTSTR lpFieldName, long& lValue, CString* errMsg /* = NULL*/)
{
	long val = (long)NULL;
	_variant_t vtFld;
...
BOOL CADORecordset::GetFieldValue(int nIndex, long& lValue, CString* errMsg /* = NULL*/)
{
	long val = (long)NULL;
	_variant_t vtFld;
	_variant_t vtIndex;
...
BOOL CADORecordset::GetFieldValue(LPCTSTR lpFieldName, unsigned long& ulValue, CString* errMsg /* = NULL*/)
{
	long val = (long)NULL;
	_variant_t vtFld;
...
BOOL CADORecordset::GetFieldValue(int nIndex, unsigned long& ulValue, CString* errMsg /* = NULL*/)
{
	long val = (long)NULL;
	_variant_t vtFld;
	_variant_t vtIndex;
...
BOOL CADORecordset::GetFieldValue(LPCTSTR lpFieldName, int& nValue, CString* errMsg /* = NULL*/)
{
	int val = NULL;
	_variant_t vtFld;
...
BOOL CADORecordset::GetFieldValue(int nIndex, int& nValue, CString* errMsg /* = NULL*/)
{
	int val = (int)NULL;
	_variant_t vtFld;
	_variant_t vtIndex;
...
BOOL CADORecordset::GetFieldValue(LPCTSTR lpFieldName, CString& strValue, CString strDateFormat, CString* errMsg /* = NULL*/)
{
	CString str;
	_variant_t vtFld;
...
BOOL CADORecordset::GetFieldValue(int nIndex, CString& strValue, CString strDateFormat, CString* errMsg /* = NULL*/)
{
	CString str;
	_variant_t vtFld;
	_variant_t vtIndex;
...
BOOL CADORecordset::GetFieldValue(LPCTSTR lpFieldName, COleDateTime& time, CString* errMsg /* = NULL*/)
{
	_variant_t vtFld;
...
BOOL CADORecordset::GetFieldValue(int nIndex, COleDateTime& time, CString* errMsg /* = NULL*/)
{
	_variant_t vtFld;
	_variant_t vtIndex;
...
BOOL CADORecordset::GetFieldValue(LPCTSTR lpFieldName, bool& bValue, CString* errMsg /* = NULL*/)
{
	_variant_t vtFld;
...
BOOL CADORecordset::GetFieldValue(int nIndex, bool& bValue, CString* errMsg /* = NULL*/)
{
	_variant_t vtFld;
	_variant_t vtIndex;
...
BOOL CADORecordset::GetFieldValue(LPCTSTR lpFieldName, COleCurrency& cyValue, CString* errMsg /* = NULL*/)
{
	_variant_t vtFld;
...
BOOL CADORecordset::GetFieldValue(int nIndex, COleCurrency& cyValue, CString* errMsg /* = NULL*/)
{
	_variant_t vtFld;
	_variant_t vtIndex;
...
BOOL CADORecordset::GetFieldValue(LPCTSTR lpFieldName, _variant_t& vtValue, CString* errMsg /* = NULL*/)
{
	try
	{
...
BOOL CADORecordset::GetFieldValue(int nIndex, _variant_t& vtValue, CString* errMsg /* = NULL*/)
{
	_variant_t vtIndex;
...
BOOL CADORecordset::IsFieldNull(LPCTSTR lpFieldName, CString* errMsg /* = NULL*/)
{
	_variant_t vtFld;
...
BOOL CADORecordset::IsFieldNull(int nIndex, CString* errMsg /* = NULL*/)
{
	_variant_t vtFld;
	_variant_t vtIndex;
...
BOOL CADORecordset::IsFieldEmpty(LPCTSTR lpFieldName, CString* errMsg /* = NULL*/)
{
	_variant_t vtFld;
...
BOOL CADORecordset::IsFieldEmpty(int nIndex, CString* errMsg /* = NULL*/)
{
	_variant_t vtFld;
	_variant_t vtIndex;
...
BOOL CADODatabase::Execute(LPCTSTR lpstrExec, CString* errMsg /* = NULL*/)
{
	ASSERT(m_pConnection != NULL);
...
BOOL CADORecordset::GetFieldInfo(LPCTSTR lpFieldName, CADOFieldInfo* fldInfo, CString* errMsg /*= NULL*/)
{
	FieldPtr pField = m_pRecordset->Fields->GetItem(lpFieldName);

	return GetFieldInfo(pField, fldInfo, errMsg);
}

BOOL CADORecordset::GetFieldInfo(int nIndex, CADOFieldInfo* fldInfo, CString* errMsg /*= NULL*/)
{
	_variant_t vtIndex;
...
BOOL CADORecordset::GetFieldInfo(FieldPtr pField, CADOFieldInfo* fldInfo, CString* errMsg /*= NULL*/)
{
...
BOOL CADORecordset::GetChunk(LPCTSTR lpFieldName, CString& strValue, CString* errMsg /* = NULL*/)
{
	FieldPtr pField = m_pRecordset->Fields->GetItem(lpFieldName);

	return GetChunk(pField, strValue, errMsg);
}

BOOL CADORecordset::GetChunk(int nIndex, CString& strValue, CString* errMsg /* = NULL*/)
{
	_variant_t vtIndex;
...
BOOL CADORecordset::GetChunk(FieldPtr pField, CString& strValue, CString* errMsg /* = NULL*/)
{
	CString str;
...
BOOL CADORecordset::GetChunk(LPCTSTR lpFieldName, LPVOID lpData, CString* errMsg /* = NULL*/)
{
	FieldPtr pField = m_pRecordset->Fields->GetItem(lpFieldName);

	return GetChunk(pField, lpData, errMsg);
}

BOOL CADORecordset::GetChunk(int nIndex, LPVOID lpData, CString* errMsg /* = NULL*/)
{
	_variant_t vtIndex;
...
BOOL CADORecordset::GetChunk(FieldPtr pField, LPVOID lpData, CString* errMsg /* = NULL*/)
{
	long lngSize, lngOffSet = 0;
	_variant_t varChunk;
	UCHAR chData;
...
BOOL CADORecordset::AppendChunk(LPCTSTR lpFieldName, LPVOID lpData, UINT nBytes, CString* errMsg /*= NULL*/)
{

	FieldPtr pField = m_pRecordset->Fields->GetItem(lpFieldName);

	return AppendChunk(pField, lpData, nBytes, errMsg);
}


BOOL CADORecordset::AppendChunk(int nIndex, LPVOID lpData, UINT nBytes, CString* errMsg /*= NULL*/)
{
	_variant_t vtIndex;
...
BOOL CADORecordset::AppendChunk(FieldPtr pField, LPVOID lpData, UINT nBytes, CString* errMsg /* = NULL*/)
{
	HRESULT hr;
	_variant_t varChunk;
	long lngOffset = 0;
...
BOOL CADORecordset::AddNew(CADORecordBinding &pAdoRecordBinding, CString* errMsg /* = NULL*/)
{
	try
	{
...
BOOL CADORecordset::Update(CString* errMsg /* = NULL*/)
{
	BOOL bret = TRUE;
...
BOOL CADORecordset::PutFieldValue(LPCTSTR lpFieldName, _variant_t vtFld, CString* errMsg /* = NULL*/)
{
	if(m_nEditStatus == dbEditNone)
		return FALSE;
...
BOOL CADORecordset::PutFieldValue(_variant_t vtIndex, _variant_t vtFld, CString* errMsg /* = NULL*/)
{
	if(m_nEditStatus == dbEditNone)
		return FALSE;
...
BOOL CADORecordset::Clone(CADORecordset &pRs, CString* errMsg /* = NULL*/)
{
	try
	{
...
BOOL CADORecordset::SetFilter(LPCTSTR strFilter, CString* errMsg /* = NULL*/)
{
	ASSERT(IsOpen());
...
BOOL CADORecordset::SetSort(LPCTSTR strCriteria, CString* errMsg /* = NULL*/)
{
	ASSERT(IsOpen());
...
BOOL CADORecordset::SaveAsXML(LPCTSTR lpstrXMLFile, CString* errMsg /* = NULL*/)
{
	HRESULT hr;
...
BOOL CADORecordset::OpenXML(LPCTSTR lpstrXMLFile, CString* errMsg /* = NULL*/)
{
	HRESULT hr = S_OK;
...
BOOL CADORecordset::Execute(CADOCommand* pAdoCommand, CString* errMsg /* = NULL*/)
{
	if(IsOpen())
		Close();
...
void CADORecordset::dump_com_error(_com_error &e, CString* errMsg /* = NULL*/)
{
	CString ErrorStr;
...
BOOL CADOCommand::AddParameter(CADOParameter* pAdoParameter, CString* errMsg /* = NULL*/)
{
...
BOOL CADOCommand::AddParameter(CString strName, int nType, int nDirection, long lSize, _variant_t vtValue, int nPrecision, int nScale, CString* errMsg /* = NULL*/)
{
	try
	{
...
BOOL CADOCommand::Execute(int nCommandType /*= typeCmdStoredProc*/, CString* errMsg /* = NULL*/)
{
	_variant_t vRecords;
	m_nRecordsAffected = 0;
	try
...
void CADOCommand::dump_com_error(_com_error &e, CString* errMsg /* = NULL*/)
{
	CString ErrorStr;
...
BOOL CADOParameter::SetValue(int nValue, CString* errMsg /* = NULL*/)
{
	_variant_t vtVal;
...
BOOL CADOParameter::SetValue(long lValue, CString* errMsg /* = NULL*/)
{
	_variant_t vtVal;
...
BOOL CADOParameter::SetValue(double dblValue, CString* errMsg /* = NULL*/)
{
	_variant_t vtVal;
...
BOOL CADOParameter::SetValue(CString strValue, CString* errMsg /* = NULL*/)
{
	_variant_t vtVal;
...
BOOL CADOParameter::SetValue(COleDateTime time, CString* errMsg /* = NULL*/)
{
	_variant_t vtVal;
...
BOOL CADOParameter::SetValue(_variant_t vtValue, CString* errMsg /* = NULL*/)
{
...
BOOL CADOParameter::GetValue(int& nValue, CString* errMsg /* = NULL*/)
{
	_variant_t vtVal;
	int nVal = 0;
...
BOOL CADOParameter::GetValue(long& lValue, CString* errMsg /* = NULL*/)
{
	_variant_t vtVal;
	long lVal = 0;
...
BOOL CADOParameter::GetValue(double& dbValue, CString* errMsg /* = NULL*/)
{
	_variant_t vtVal;
	double dblVal;
	try
...
BOOL CADOParameter::GetValue(CString& strValue, CString strDateFormat, CString* errMsg /* = NULL*/)
{
	_variant_t vtVal;
	CString strVal;
...
BOOL CADOParameter::GetValue(COleDateTime& time, CString* errMsg /* = NULL*/)
{
	_variant_t vtVal;
...
BOOL CADOParameter::GetValue(_variant_t& vtValue, CString* errMsg /* = NULL*/)
{
	try
	{
...
void CADOParameter::dump_com_error(_com_error &e, CString* errMsg /* = NULL*/)
{
	CString ErrorStr;
